...
import io.github.mangocrisp.spring.taybct.tool.core.constant.ROLE;
 ...
 * 1、 在 io.github.mangocrisp.spring.taybct.api.system.dto.OAuth2UserDTO 里面加信息<br>
 * 2、 在 io.github.mangocrisp.spring.taybct.auth.security.pojo.OAuth2UserDetails 里面加信息<br>
 * 3、 在 io.github.mangocrisp.spring.taybct.auth.security.config.AuthorizationServerConfig.tokenEnhancer() 里面把信息写入到 jwt token 的载体里面<br>
 *
