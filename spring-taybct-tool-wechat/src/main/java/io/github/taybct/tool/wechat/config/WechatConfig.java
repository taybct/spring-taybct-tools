package io.github.taybct.tool.wechat.config;

import com.alibaba.fastjson2.JSONObject;
import io.github.taybct.tool.core.util.HttpClientUtil;
import io.github.taybct.tool.wechat.constants.CacheConstants;
import io.github.taybct.tool.wechat.util.Decript;
...
public class WechatConfig {
    ...
    public String getAuthorizationUrl(String state) {
        ...
        return String.format(wxAuthorizationUrl,
                this.appId
                , URLEncoder.encode(this.redirectUrl, StandardCharsets.UTF_8)
                , SCOPE
                , state
        );
    }
