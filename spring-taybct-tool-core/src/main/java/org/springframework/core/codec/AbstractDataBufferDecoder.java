...
public abstract class AbstractDataBufferDecoder<T> extends AbstractDecoder<T> {
    ...
    private static int maxInMemorySize = 256 * 1024;
    ...
    public void setMaxInMemorySize(int byteCount) {
        AbstractDataBufferDecoder.maxInMemorySize = byteCount;
    }
    ...
    public int getMaxInMemorySize() {
        return AbstractDataBufferDecoder.maxInMemorySize;
    }
    ...
    public Mono<T> decodeToMono(Publisher<DataBuffer> input, ResolvableType elementType,
        ...
        return DataBufferUtils.join(input, AbstractDataBufferDecoder.maxInMemorySize)
