...
public class EncryptedDataSourceProperties {
    ...
    /**
     * 解密方法，为每个数据源 指定一个 {@code Function<String, String>} 类来实现解密,怎么解密要看具体是怎么加密的，例如，sm4 加密的就用 {@code SM4Coder.En}
     *
     * @see io.github.mangocrisp.spring.taybct.tool.core.util.sm.SM4Coder.En
     */
