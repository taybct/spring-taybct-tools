...
public class CollectionSortUtil {
    ...
    public static <T> List<T> sortListByName(List<T> source, String sortName, Boolean asc) {
        ...
        List<T> result = BeanUtil.copyToList(source, clazz);
        ...
        try {
            ...
            result.sort((o1, o2) -> {
                ...
                try {
                    optional1 = Optional.ofNullable(field.get(o1));
                    optional2 = Optional.ofNullable(field.get(o2));
     ...
     * @since 1.0.0
     */
    static String[] removeEmptyChar(String[] source) {
